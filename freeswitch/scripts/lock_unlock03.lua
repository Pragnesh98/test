...
local function lock_unlock(session, conference_name, CallUUID)
	...
	--reply = api:executeString("lua keypad_commands.lua "..tostring(conference_name).." "..tostring(aleg_uuid))
		cnt = 0
		session:sleep(1000);
