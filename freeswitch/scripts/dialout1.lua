				...
				while(Retry1 < MaxReTry ) do
						...
						if(user_input == "1") then
							session:execute("playback", sounds_dir.."/option_not_available.wav");
						  	Retry = MaxReTry + 1;
								Retry1 = MaxReTry + 1;
								sofia_str = "{origination_caller_id_number='+912230332447',origination_caller_id_name='+912230332447'}sofia/internal/"..tostring(number).."@13.56.34.153:5060;fs_path=sip:172.31.21.244"
